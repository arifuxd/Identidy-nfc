...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — Identidy" },
      { name: "description", content: "Design-led hardware, software-first thinking, and a stubborn belief in privacy — the story behind Identidy." },
      { property: "og:title", content: "About — Identidy" },
      { property: "og:description", content: "The story, mission and craft behind Identidy." },
    ],
  }),
  component: About,
});
