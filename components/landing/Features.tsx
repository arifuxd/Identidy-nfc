    ...
    <section id="features" className="features-section">
      <div className="container">
        ...
        <div className="features-grid stagger">
          <div className="feat-col-8 feat-card feat-card-blue reveal"><div className="feat-icon feat-icon-white"><Globe {...iconProps} /></div><div className="url-bar"><div className="url-favicon" /><span className="url-text">identidy.net/yourname</span></div><h3 className="feat-title feat-title-white" style={{ fontSize: 22 }}>Your URL. Your Identidy.</h3><p className="feat-desc feat-desc-white">A unique shareable link that stays up to date all the time.</p></div>
