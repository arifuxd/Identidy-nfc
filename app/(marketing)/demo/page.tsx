              ...
              <div className="relative overflow-hidden rounded-[38px] bg-background">
                ...
                <div className="-mt-12 px-5 pb-6">
                  ...
                  <div className="mt-4 text-center">
                    <h2 className="font-display text-2xl tracking-tight text-foreground">Ayaan Rahman</h2>
                  ...
                  <div className="mt-5 grid grid-cols-4 gap-2">
                    {[Instagram, Linkedin, Globe, Mail].map((I, i) => (
                      <a key={i} href="#" className="grid aspect-square place-items-center rounded-xl border border-hairline transition-transform hover:scale-105">
                        <I size={16} className="text-foreground" />
                      </a>
                    ))}
                  </div>
                  ...
                  <div className="mt-5 space-y-2">
                    {[
                      ...
                      return (
                        <div key={i} className="flex items-center gap-3 rounded-xl border border-hairline p-3 text-sm text-foreground">
                  ...
                  <div className="mt-6">
                    ...
                    >
                      <input required placeholder="Your name" className="w-full rounded-xl border border-hairline bg-background px-3 py-2.5 text-sm outline-none focus:border-accent text-foreground" />
                      <input required type="email" placeholder="Email" className="w-full rounded-xl border border-hairline bg-background px-3 py-2.5 text-sm outline-none focus:border-accent text-foreground" />
            ...
            <ul className="mt-8 grid gap-4 sm:grid-cols-2">
              {[
                ...
                <li key={h} className="rounded-2xl border border-hairline p-5">
                  <h3 className="font-medium text-foreground">{h}</h3>
